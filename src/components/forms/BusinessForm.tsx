          ...
          <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="p-5 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div
                  className={disablePhone ? "opacity-70 grayscale-[0.5]" : ""}
                >
                  <PhoneInput
                    defaultCountry="in"
        ...
        <div className="lg:col-span-8 space-y-6">
          ...
          <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
            <div className="p-4 border-b border-border bg-muted/30">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                AI prompts and links for your initial QR code
              </p>
            </div>
            ...
            <div className="p-6 space-y-6">
              <div className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  This will be the default review link for your first QR code. High ratings will be redirected here.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t">
                <div className="space-y-3">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    Guide how our AI generates feedback for your first QR code.
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Sets the tone of voice for AI-suggested review drafts for
                    happy customers.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
            <div className="p-4 border-b border-border bg-muted/30">
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Control which ratings go to Google and which are kept as private
                feedback
              </p>
            </div>
            <div className="p-6">
              <div className="mb-6 flex space-x-2 p-3 bg-blue-500/10 text-blue-600 dark:text-blue-400 rounded-lg text-sm font-medium items-start">
                ...
                <p>
                  Click on a star to set the threshold. Ratings{" "}
                  <strong>up to the selected star</strong> will be directed to
                  an internal suggestion form, while{" "}
                  <strong>higher ratings</strong> will be encouraged to review
                  on Google Maps.
                </p>
              </div>
                  ...
                  {[1, 2, 3, 4, 5].map((star) => {
                    ...
                    return (
                      <button
                        ...
                        title={
                          isSuggestion ? "Internal Feedback" : "Google Review"
                        }
                      >
                        <Star
                          className={`w-8 h-8 ${isSuggestion ? "" : "fill-current"}`}
                          strokeWidth={isSuggestion ? 2 : 1}
                        />
                      </button>
                    );
                  })}
                ...
                <div className="flex justify-between w-full max-w-sm mt-6 text-sm">
                  <div className="flex flex-col items-center gap-1 text-orange-600 dark:text-orange-400 font-medium">
                    <span className="px-2 py-0.5 rounded-full bg-orange-100 dark:bg-orange-900/40 text-xs">
                      {formData.notAcceptedStars === 1
                        ? "1 Star"
                        : `1-${formData.notAcceptedStars} Stars`}
                    </span>
                    <span>Internal Suggestions</span>
                  </div>
                  {formData.acceptedStars <= 5 &&
                  formData.notAcceptedStars < 5 ? (
                    <div className="flex flex-col items-center gap-1 text-green-600 dark:text-green-400 font-medium">
                      <span className="px-2 py-0.5 rounded-full bg-green-100 dark:bg-green-900/40 text-xs">
                        {formData.acceptedStars === 5
                          ? "5 Stars"
                          : `${formData.acceptedStars}-5 Stars`}
                      </span>
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            ...
            <Button
              ...
              className="gap-2 px-8 min-w-[140px] shadow-sm"
            >
